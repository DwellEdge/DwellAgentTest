  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(135deg, #fff7f3 0%, #ffe8dc 50%, #fff7f3 100%)' }}>
      ...
      <main className="flex-1 max-w-5xl mx-auto p-8">
        <h1 className="text-2xl font-extrabold text-[#7c2d12] mb-4">Contact Us</h1>
        <p className="text-sm text-slate-700">For support and Razorpay onboarding queries, please email support@dwellagent.example or call +91-XXXXXXXXXX. We typically respond within 2 business days.</p>
      </main>
