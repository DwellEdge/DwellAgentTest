  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(135deg, #fff7f3 0%, #ffe8dc 50%, #fff7f3 100%)' }}>
      ...
      <main className="flex-1 max-w-5xl mx-auto p-8">
        <h1 className="text-2xl font-extrabold text-[#7c2d12] mb-4">Shipping & Delivery</h1>
        <p className="text-sm text-slate-700">DwellAgent primarily provides digital services and agent connections. Physical deliveries (if any) follow partner terms; contact support for specific delivery queries.</p>
      </main>
